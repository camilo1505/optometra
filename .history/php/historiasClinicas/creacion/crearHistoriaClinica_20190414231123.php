...
<body>
	...
	<div id="content">
		<div class="container">
			<div class="jumbotron">
				<h1>Crear Historia Clinica de <?php print($datosClientes[0]['primer_apellido'] . " " . $datosClientes[0]['segundo_apellido']. " " . $datosClientes[0]['primer_nombre']. " " . $datosClientes[0]['segundo_nombre']); ?>.</h1>
				<br>
