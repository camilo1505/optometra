<?php
    ...
    $result = getData($buscarCliente,'jp', '1234');
    ...
    $sql = "INSERT INTO historia_clinica ( fk_usuario , fk_cliente , patologia1 , patologia2 , patologia3 ,
                        tratamiento1 , tratamiento2 , tratamiento3 , cronicidad1 , cronicidad2 , cronicidad3 ,
                        observacion1 , observacion2 , observacion3 , anamnesis , rx_uso_od_esfera ,
                        rx_uso_od_cilindro , rx_uso_od_eje , rx_uso_od_adicion , rx_uso_oi_esfera ,
                        rx_uso_oi_cilindro , rx_uso_oi_eje , rx_uso_oi_adicion , vision_lejos_od ,
                        vision_lejos_oi , vision_cerca_od , vision_cerca_oi , examen_externo_od , examen_externo_oi ,
                        reflejos_pupilares_fotomotor , reflejos_pupilares_consensual , reflejos_pupilares_acomodacion ,
                        cover_test_vision_lejos , cover_test_vision_proxima , cover_test_ducciones ,
                        cover_test_versiones , od_oftalmoloscopio , oi_oftalmoloscopio , od_queratrometra ,
                        oi_queratrometra , od_retinoscopia , oi_retinoscopia , rx_final_od_esfera , rx_final_od_cilindro ,
                        rx_final_od_eje , rx_final_od_adicion , rx_final_oi_esfera , rx_final_oi_cilindro , rx_final_oi_eje,
                        rx_final_oi_adicion , rx_final_od_agudes_visual , rx_final_oi_agudes_visual , diagnostico ,
                        control , observacion , fecha) 
                VALUES ($fk_usuario,$fk_cliente,'$patologia1','$patologia2','$patologia3','$tratamiento1','$tratamiento2',
                        '$tratamiento3','$cronicidad1','$cronicidad2','$cronicidad3','$observacion1','$observacion2',
                        '$observacion3','$anamnesis','$rx_uso_od_esfera','$rx_uso_od_cilindro','$rx_uso_od_eje','
                        $rx_uso_od_adicion','$rx_uso_oi_esfera','$rx_uso_oi_cilindro','$rx_uso_oi_eje','$rx_uso_oi_adicion',
                        '$vision_lejos_od','$vision_lejos_oi','$vision_cerca_od','$vision_cerca_oi','$examen_externo_od',
                        '$examen_externo_oi','$reflejos_pupilares_fotomotor','$reflejos_pupilares_consensual',
                        '$reflejos_pupilares_acomodacion','$cover_test_vision_lejos','$cover_test_vision_proxima',
                        '$cover_test_ducciones','$cover_test_versiones','$od_oftalmoloscopio','$oi_oftalmoloscopio',
                        '$od_queratrometra','$oi_queratrometra','$od_retinoscopia','$oi_retinoscopia','$rx_final_od_esfera',
                        '$rx_final_od_cilindro','$rx_final_od_eje','$rx_final_od_adicion','$rx_final_oi_esfera',
                        '$rx_final_oi_cilindro','$rx_final_oi_eje','$rx_final_oi_adicion','$rx_final_od_agudes_visual',
                        '$rx_final_oi_agudes_visual','$diagnostico','$control','$observacion','$hoy')";
