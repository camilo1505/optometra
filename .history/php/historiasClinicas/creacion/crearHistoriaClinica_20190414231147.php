...
<body>
	...
	<div id="content">
		<div class="container">
			<div class="jumbotron">
				<h1>Crear Historia Clinica de <b> <?php print($datosClientes[0]['primer_apellido'] . " " . $datosClientes[0]['segundo_apellido']. " " . $datosClientes[0]['primer_nombre']. " " . $datosClientes[0]['segundo_nombre']); ?></b>.</h1>
				<br>
