    ...
    <div class="container">
      <div class="f-center">
        ...
        if ($_SESSION['rol'] == "1" || $_SESSION['rol'] == "3") {
          ?>
            <a class="list-group-item list-group-item-action" href="catalogo.php">Catálogo</a>
          <?php
        }
        ...
        if ($_SESSION['rol'] == "1" || $_SESSION['rol'] == "2") {
          ?>
            <a class="list-group-item list-group-item-action" href="historiaClinica.php">Historias Clínicas</a>
          <?php
        }
        ?>
