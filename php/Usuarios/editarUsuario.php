                ...
                ?>
                    ...
                    <form action="modificar.php" method="post">
                        <tr>
                            ...
                            <td><input name="contraseña" type="text" placeholder="nueva contraseña"> </td>
                            <td>
                                <select name="rol">
                            <?php
                                foreach($result as $resultado){
                            ...
                            ?>
                                <option value="<?php echo $result_rol[0]['fk_rol'];?>">
                                    <?php 
                                        $sql = "SELECT * FROM ROL WHERE id_rol = $result_rol[0]['fk_rol']";
                                        $rol = getData($sql,'root','');
                                    ?>
                                </option>
                            <?php
                                }
