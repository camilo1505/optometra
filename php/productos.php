        ...
        <div class="container">
            <div class="f-center">
                <div class="list-group">
                    ...
                    ?>
                        <a class="list-group-item list-group-item-action" href="productos/addProducto.php">Añadir Productos</a>
                    <?php
                }
                if (in_array($_SESSION['rol'], array("1", "3"))) {
                    ?>
                        <a class="list-group-item list-group-item-action" href="productos/editarProducto.php">Editar Productos</a>
                        <?php
                        if (in_array($_SESSION['rol'], array("1", "3"))) {
                            ?>
                            <a class="list-group-item list-group-item-action" href="productos/eliminarProducto.php">Activar o inactivar Productos</a>
                        <?php
                    }
                    ?>
                    <br>
